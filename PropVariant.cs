/*
 *  For details regarding the PropVariant struct, please read the article "Interop with
 *  PROPVARIANTs in .NET" by Adam Root.
 * 
...
namespace GetDuration
{
    ...
    ///     
    /// Note: Represents the OLE struct PROPVARIANT.  Must call Clear when finished to
    ///       avoid memory leaks. If you get the value of a VT_UNKNOWN prop, an implicit
    ///       AddRef is called, thus your reference will be active even after the
    ///       PropVariant struct is cleared.
    ///       
